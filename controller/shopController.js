...
class ShopController {
    ...
    static async createShop(req, res) {
        try {
            const { shop_nom, phone, shop_desc, shop_local, shop_date_ouv, shop_date_ferm, user_id , shopImage} = req.body; // les attributs mt3 shom hatinehom f req 
            ...
            const newShop = new Shop({ shop_nom, phone, shop_desc, shop_local, shop_date_ouv, shop_date_ferm, user_id ,shopImage});
            await newShop.save();
